<x-layout>
        ...
        <div class="container-xl mt-5">
            <a href="{{ route('clientes.index') }}" class="btn btn-success text-white">Regresar</a>
        ...
        <div class="d-flex justify-content-center mb-5 ">
            ...
            <form action="{{ route('clientes.update',$project) }}" method="post" class="row g-3 border border-ligth rounded-2 d-flex justify-content-center bg-white">
            @csrf    
                @method('PUT')
                    ...
                    <div class="col-12">
                        ...
                        <div class="row">
                            <div class="col-6">
                                ...
                                style="height:80px;">{{ old('description', $project->description) }}</textarea>
                            </div>
                            <div class="col-6">
                                ...
                                <textarea name="problem" id="" cols="20" rows="10" class="form-control" placeholder="Máximo 1,000 caracteres." 
                                 style="height:80px;">{{ old('problem', $project->problem) }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-6">
                                ...
                                <textarea name="solution" id="" cols="20" rows="10" class="form-control" placeholder="Máximo 1,000 caracteres." 
                                 style="height:80px;">{{ old('solution', $project->solution) }}</textarea>
                            </div>
                            <div class="col-6">
                                ...
                                style="height:80px;">{{ old('implementations', $project->implementations) }}</textarea>
                            </div>
                        </div>
                        ...
                        <textarea name="benefits" id="" cols="20" rows="10" class="form-control" placeholder="Máximo 1,000 caracteres." 
                         style="height:80px;">{{ old('benefits', $project->benefits) }}</textarea>

                        <div class="col-auto">
                            <button type="submit" class="btn btn-outline-success  my-3">Actualizar</button>
                        </div>
                    </div>
                </div>
            </form>
